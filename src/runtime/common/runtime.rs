...
bitflags! {
    ...
    pub struct ScheduleFlags: u32 {
        ...
        const SCHEDULE_DISABLE_RENDERPASS_TRANSITIONS = ffi::RpsScheduleFlagBits_RPS_SCHEDULE_DISABLE_RENDERPASS_TRANSITIONS_BIT as _;
        const SCHEDULE_DEFAULT = ffi::RpsScheduleFlagBits_RPS_SCHEDULE_DEFAULT as _;
        const SCHEDULE_DEFAULT_PERFORMANCE = ffi::RpsScheduleFlagBits_RPS_SCHEDULE_DEFAULT_PERFORMANCE as _;
        const SCHEDULE_DEFAULT_MEMORY = ffi::RpsScheduleFlagBits_RPS_SCHEDULE_DEFAULT_MEMORY as _;
    }
}
